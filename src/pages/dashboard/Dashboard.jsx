...
// FIX: NavItem moved outside parent (S6478), uses <button> (S6848 + S1082), PropTypes added (S6774)
...
export const DashboardLayout = ({ children, title }) => {
    ...
    // FIX: removed useState/setUser — setter was never called (S1854, S1481)
...
// FIX: PropTypes for DashboardLayout (S6774)

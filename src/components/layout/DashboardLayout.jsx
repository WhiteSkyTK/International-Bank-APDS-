...
import {
    ...
    MessageSquare, ShieldCheck, LogOut, X, Clock, AlertTriangle
} from 'lucide-react';
import { useInactivityLogout } from '../../hooks/useInactivityLogout';

// ─── Static sample notifications (replace with API call when backend supports it) ───
const SAMPLE_NOTIFICATIONS = [
    {
        id: 1,
        icon: '✅',
        title: 'Payment Submitted',
        body: 'Your SWIFT transfer is queued for processing.',
        time: '2 min ago',
        read: false
    },
    {
        ...
        body: 'A new session was started on this device.',
        time: '1 hr ago',
        read: false
    },
    {
        ...
        body: 'Your March 2026 statement is available.',
        time: 'Yesterday',
        read: true
    }
];
        ...
        <div className="flex h-screen bg-[#E5E7EB] font-sans">
            ...
            <div className="w-64 lg:w-72 bg-[#1C4382] text-white flex flex-col p-4 lg:p-6 shadow-xl z-20 hidden md:flex shrink-0">
                ...
                <nav className="space-y-1 mb-6">
                    ...
                    <NavItem icon={<History size={20} />}    label="Transactions"  path="/transactions" count={unreadCount} />
                </nav>
                                            ...
                                            notifications.map((n) => (
                                                ...
                                                >
                                                    ...
                                                    <div className="flex-grow min-w-0">
                                                        <p className={`text-xs font-bold text-gray-800 ${!n.read ? 'text-[#1C4382]' : ''}`}>
                                                            {n.title}
                                                        </p>
